	...
	<input type="hidden" name="who" value="student" />
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="" name="sno" id="sno" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="password">密码</label>
						<div class="controls">
							<input type="password" class="" name="spwd" id="spwd" />
						</div>
					</div>
		...
		<div id="login-extra">
			<p>您是教师? <a href="./login_teacher.jsp">教师入口>></a></p>
			<p>没有账号? <a href="./register.jsp">现在注册.</a></p>
