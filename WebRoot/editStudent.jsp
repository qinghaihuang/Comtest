						...
						<br />
							...
							<div class="tab-content">
								<div class="tab-pane active" id="1">
									<form action="student.action" method="post" name="frm1" id="edit-profile" class="form-horizontal">
										<fieldset>
											
											<div class="control-group">											
												<label class="control-label" for="sno">学号</label>
												<div class="controls">
													<input type="text" class="input-mini disabled" name="sno" value="<%=sno %>" readonly = "readonly" />
													<p class="help-block">学号不可更改!</p>
												</div> <!-- /controls -->				
											</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<%-- <input type="text" class="input-mini" name="ssex"  value=<%=ssex %> /> --%>
												<select name="ssex">
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="sclass"  value=<%=sclass %>/>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="sdept"  value=<%=sdept %>/>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										
										<div class="control-group">											
											<label class="control-label" for="lastname">成绩</label>
											<div class="controls">
												<input type="text" class="input-medium" name="sscore"  value=<%=sscore %> />
											</div> <!-- /controls -->	
