...
<div id="content">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span9">
				...
				<!--按编号查找题目  -->
				<form action="queryQuestionResult.jsp" method="post" name="frm1">
					<div class="control-group">											
											<!-- <label class="control-label" for="password1">请输入题目编号:</label> -->
											<div class="controls">
												<input type="text" class="input-medium" name="qid" value="请输入题目编号" />
  ...
  session.setAttribute("qlist",qt.queryAllQuestions());
	%> 
