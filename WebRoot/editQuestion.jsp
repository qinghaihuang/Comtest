						...
						<br />
							...
							<div class="tab-content">
								<div class="tab-pane active" id="1">
									<form action="question.action" method="post" name="frm1" id="edit-profile" class="form-horizontal">
										<fieldset>
											
											<div class="control-group">											
												<label class="control-label" for="id">题目编号</label>
												<div class="controls">
													<input type="text" class="input-mini disabled" name="id" value="${id }" readonly = "readonly" />
													<p class="help-block">题目编号不可更改!</p>
												</div> <!-- /controls -->				
											</div> <!-- /control-group -->
												...
												<div class="controls">
													<input type="text" class="input-xlarge " name="qcontent"  value=${qcontent } />
												</div> <!-- /controls -->				
											</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<%-- <input type="text" class="input-mini" name="qtype"  value=${qtype } /> --%>
												<select name="qtype">
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="aanswer"  value=${ aanswer} />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="banswer"  value=${banswer } />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="canswer"  value=${canswer } />
											</div> <!-- /controls -->	
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="danswer"  value=${danswer } />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<%-- <input type="text" class="input-medium" name="tanswer"  value=${tanswer } /> --%>
												<select name="tanswer">
