<%@ page language="java" import="java.util.*,entity.Teacher,dao.TeacherDao" pageEncoding="UTF-8"%>
...
<div id="content">
			...
			<div class="span9">
				...
				<h1 class="page-title">
					...
					<div class="widget-content">
					 <form action="teacherBank.jsp" method="post" name="frm2">
  ...
  session.setAttribute("tlist",td.queryAllTeachers());
	%> 
   ...
   <td>${t.tdept}</td>    
 <td>
<a href="teacher.action?opttype=edit&tno=${t.tno}&tname=${t.tname}&tsex=${t.tsex}&tdept=${t.tdept}
" class="btn btn-small btn-warning">
<i class="icon-ok"></i>								
</a>					
<a href="teacher.action?opttype=delete&tno=${t.tno}" class="btn btn-small">
