				...
				<div class="row">
					...
					<div class="span9">
						...
						<ul class="nav nav-tabs">
						  <li class="active">
						    <a href="#1" data-toggle="tab">添加教师</a>
						  </li>
						</ul>
						...
						<br />
							...
							<div class="tab-content">
								...
								<form action="teacher.action"  method="post" id="edit-profile" class="form-horizontal">
									<fieldset>
										
										<div class="control-group">											
											<label class="control-label" for="username">教师工号</label>
											<div class="controls">
												<input type="text" class="input-xlarge " name="tno" id="username" value="请输入教师工号" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="tname" id="lastname" value="XX" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="tdept" id="lastname" value="XX" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
